              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem' }}>
                    <div style={{ fontSize: '0.95rem', fontWeight: 700, color: '#0F1A34', lineHeight: 1.3 }}>
                      {call.title}
                    </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
                  <span style={{ fontSize: '0.875rem', fontWeight: 700, color: '#0F1A34' }}>
                    {call.duration}
                  </span>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.3rem' }}>
                        <span style={{ fontSize: '1.85rem', fontWeight: 800, color: '#0F1A34', lineHeight: 1.1 }}>
                          {call.moodScore}
                        </span>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', marginTop: '0.35rem', fontSize: '0.85rem', fontWeight: 700, color: '#0F1A34' }}>
                    ...
                    {call.objections.length === 0 ? (
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
                        {call.objections.map((obj, i) => (
                          <div key={i} style={{ fontSize: '0.85rem', color: '#0F1A34', fontWeight: 500, display: 'flex', alignItems: 'flex-start', gap: '0.4rem' }}>
                    ...
                    >
                      <div>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
                          <h4 style={{ margin: 0, fontSize: '1.05rem', fontWeight: 800, color: '#0F1A34' }}>
                            Agent Checklist
                          </h4>
                          <span
                            style={{
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                            {call.checklistItems.map((item, i) => (
                              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.55rem' }}>
                                ...
                                <span style={{ fontSize: '0.825rem', color: '#0F1A34', fontWeight: 600 }}>
                                  {item.text}
                                </span>
                              </div>
                            ))}
                        ...
                        {call.keyPoints.length === 0 ? (
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
                            {call.keyPoints.map((kp, i) => (
                              <div key={i} style={{ fontSize: '0.825rem', color: '#0F1A34', fontWeight: 500 }}>
                                • {kp}
                              </div>
                            ))}
                          </div>
